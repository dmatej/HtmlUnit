...
import static jdk2.nashorn.internal.tools.nasgen.StringConstants.OBJECT_ARRAY_DESC;
...
public final class MemberInfo implements Cloneable {
    ...
    // keep in sync with jdk2.nashorn.internal.objects.annotations.Attribute
