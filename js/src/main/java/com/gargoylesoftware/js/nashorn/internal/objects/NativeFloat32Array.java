...
public final class NativeFloat32Array extends ArrayBufferView {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeFloat32Array.class,
...
null));
        ...
        Constructor() {
            super("Float32Array", 
                    staticHandle("constructor", NativeFloat32Array.class, boolean.class, Object.class, Object[].class),
                    $nasgenmap$, null);
    ...
    static final class Prototype extends PrototypeObject {
        ...
        Prototype() {
            ...
            subarray = ScriptFunction.createBuiltin("subarray",
                    staticHandle("subarray", NativeFloat32Array.class, Object.class, Object.class, Object.class));
        }
