...
import static com.gargoylesoftware.js.nashorn.internal.runtime.JSType.isString;
...
import com.gargoylesoftware.js.nashorn.internal.runtime.GlobalConstants;
...
import com.gargoylesoftware.js.nashorn.tools.ShellFunctions;
...
public final class Global extends Scope {
    ...
    @Override
    public void addBoundProperties(final ScriptObject source, final com.gargoylesoftware.js.nashorn.internal.runtime.Property[] properties) {
        ...
        if (context.getEnv()._es6) {
            ...
            for (final com.gargoylesoftware.js.nashorn.internal.runtime.Property property : properties) {
                if (property.isLexicalBinding()) {
                    hasLexicalDefinitions = true;
                }
                // ES6 15.1.8 steps 6. and 7.
                final com.gargoylesoftware.js.nashorn.internal.runtime.Property globalProperty = ownMap.findProperty(property.getKey());
                ...
                final com.gargoylesoftware.js.nashorn.internal.runtime.Property lexicalProperty = lexicalMap.findProperty(property.getKey());
    ...
    private <T extends ScriptObject> T initConstructor(final String name, final Class<T> clazz) {
        try {
            ...
            final StringBuilder sb = new StringBuilder("com.gargoylesoftware.js.nashorn.internal.objects.");
    ...
    private List<com.gargoylesoftware.js.nashorn.internal.runtime.Property> extractBuiltinProperties(final String name, final ScriptObject func) {
        final List<com.gargoylesoftware.js.nashorn.internal.runtime.Property> list = new ArrayList<>();
        ...
        final com.gargoylesoftware.js.nashorn.internal.runtime.Property prop = getProperty(name);
        if (prop != null) {
            list.add(prop);
        }
    ...
    private void tagBuiltinProperties(final String name, final ScriptObject func) {
        ...
        for (final com.gargoylesoftware.js.nashorn.internal.runtime.Property prop : extractBuiltinProperties(name, func)) {
    ...
    private void initFunctionAndObject() {
        ...
        com.gargoylesoftware.js.nashorn.internal.runtime.Property[] properties = getFunctionPrototype().getMap().getProperties();
        for (final com.gargoylesoftware.js.nashorn.internal.runtime.Property property : properties) {
        ...
        for (final com.gargoylesoftware.js.nashorn.internal.runtime.Property property : builtinObject.getMap().getProperties()) {
            final Object key = property.getKey();
    ...
    private static class LexicalScope extends ScriptObject {
        ...
        @Override
        protected PropertyMap addBoundProperty(final PropertyMap propMap, final ScriptObject source, final com.gargoylesoftware.js.nashorn.internal.runtime.Property property, final boolean extensible) {
