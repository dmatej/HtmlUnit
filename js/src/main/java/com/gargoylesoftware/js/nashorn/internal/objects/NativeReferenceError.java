...
public final class NativeReferenceError extends ScriptObject {
     ...
     */
    @com.gargoylesoftware.js.nashorn.internal.objects.annotations.Constructor(name = "ReferenceError")
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeReferenceError.class,
    ...
    private static MethodHandle virtualHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findVirtual(NativeReferenceError.class, name,
    ...
    static final class Constructor extends ScriptFunction {
        Constructor() {
            super("ReferenceError", 
                    staticHandle("constructor", NativeReferenceError.class, boolean.class, Object.class, Object.class),
                    null);
