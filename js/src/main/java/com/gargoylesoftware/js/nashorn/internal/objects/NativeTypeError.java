...
public final class NativeTypeError extends ScriptObject {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeTypeError.class,
    ...
    private static MethodHandle virtualHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findVirtual(NativeTypeError.class, name,
    ...
    static final class Constructor extends ScriptFunction {
        Constructor() {
            super("TypeError", 
                    staticHandle("constructor", NativeTypeError.class, boolean.class, Object.class, Object.class),
                    null);
