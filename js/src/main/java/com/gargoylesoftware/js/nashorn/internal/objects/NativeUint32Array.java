...
public final class NativeUint32Array extends ArrayBufferView {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeUint32Array.class,
    ...
    static final class Constructor extends ScriptFunction {
        ...
        Constructor() {
            super("Uint32Array", 
                    staticHandle("constructor", NativeUint32Array.class, boolean.class, Object.class, Object[].class),
                    $nasgenmap$, null);
    ...
    static final class Prototype extends PrototypeObject {
        ...
        Prototype() {
            ...
            subarray = ScriptFunction.createBuiltin("subarray",
                    staticHandle("subarray", NativeUint32Array.class, Object.class, Object.class, Object.class));
        }
