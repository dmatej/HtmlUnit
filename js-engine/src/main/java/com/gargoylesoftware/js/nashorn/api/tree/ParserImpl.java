...
final class ParserImpl implements Parser {
    ...
    private com.gargoylesoftware.js.nashorn.internal.parser.Parser makeParser(final Source source, final DiagnosticListener listener) {
        final ErrorManager errMgr = listener != null? new ListenerErrorManager(listener) : new Context.ThrowErrorManager();
        return new com.gargoylesoftware.js.nashorn.internal.parser.Parser(env, source, errMgr);
    }
