...
public final class NativeEvalError extends ScriptObject {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeEvalError.class,
    ...
    private static MethodHandle virtualHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findVirtual(NativeEvalError.class, name,
    ...
    static final class Constructor extends ScriptFunction {
        Constructor() {
            super("EvalError", 
                    staticHandle("constructor", NativeEvalError.class, boolean.class, Object.class, Object.class),
                    null);
