...
public final class NativeInt8Array extends ArrayBufferView {
    ...
    private static MethodHandle staticHandle(final String name, final Class<?> rtype, final Class<?>... ptypes) {
        try {
            return MethodHandles.lookup().findStatic(NativeInt8Array.class,
...
null));
        ...
        Constructor() {
            super("Int8Array", 
                    staticHandle("constructor", NativeInt8Array.class, boolean.class, Object.class, Object[].class),
                    $nasgenmap$, null);
    ...
    static final class Prototype extends PrototypeObject {
        ...
        Prototype() {
            ...
            subarray = ScriptFunction.createBuiltin("subarray",
                    staticHandle("subarray", NativeInt8Array.class, Object.class, Object.class, Object.class));
        }
